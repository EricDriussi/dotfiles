...
alias l="eza --group --all --long --icons"
...
alias tre="eza --all --icons --group-directories-first --tree --level=2 --ignore-glob='node_modules|.git|.idea'"
...
alias freeport=kill_process_by_port; kill_process_by_port() { sudo lsof -ti:"$1" | xargs -r sudo kill }
